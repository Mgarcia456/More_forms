...
//       =====================VALIDATIONS ======================================
    ...
    return (
        //     the form itself and also putting the validations
        // add prevent default so iot doesnt refresh
        //  use portals to add the validations check in the form
        // use portal to add coresspponding value to its coressponding input with its correspmdiong validations
        <form onSubmit={(e) => e.preventDefault()}>
            ...
            {/*    displaying your form input down below the form */}
            <div>
...
//   export the form and add it to app.js and code and test
export default Form;